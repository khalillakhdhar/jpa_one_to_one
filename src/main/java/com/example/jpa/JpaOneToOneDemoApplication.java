...
public class JpaOneToOneDemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User user = new User("Khalil", "Lakhdhar", "contact@protech-it.org",
				"MY_SUPER_SECRET_PASSWORD");

		Calendar dateOfBirth = Calendar.getInstance();
		dateOfBirth.set(1990, 12, 9);

		// Create a UserProfile instance
		UserProfile userProfile = new UserProfile("+216-20111444", Gender.MALE, dateOfBirth.getTime(),
				"555", "2", "cité, El Amel", "Gabés sud",
				"Gabés", "Tunisia", "6033");
